...
class DRA2Adapter(options: FirestoreRecyclerOptions<DailyReport>,
                  private val listener: DailyReportAdd2Fragment
) :
    FirestoreRecyclerAdapter<DailyReport, DRA2Adapter.DRA2ViewHoder>(options) {
