...
import com.juan.pinya.view.main.dailyReport.DailyReportViewHolder
import java.util.*
import kotlin.collections.ArrayList
import kotlin.collections.HashMap

abstract class DailyReportSwipeHelper(
    context: Context,
    private val recyclerView: RecyclerView,
    private val buttonWith: Int
    ...
    override fun onChildDraw(
        ...
        val dailyReportViewHolder = viewHolder as? DailyReportViewHolder ?: return
        val pos = dailyReportViewHolder.adapterPosition
        var translationX = dX
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            if (dX < 0) {
                ...
                if (!buttonBuffer.containsKey(pos)) {
                    val dailyReport = dailyReportViewHolder.dailyReport ?: return
                    instantiateMyButton(dailyReport, buffer)
