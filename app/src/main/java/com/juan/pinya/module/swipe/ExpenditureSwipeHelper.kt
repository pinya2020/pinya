...
import com.juan.pinya.view.main.expenditure.ExpenditureViewHolder
import java.util.*
import kotlin.collections.ArrayList
import kotlin.collections.HashMap

abstract class ExpenditureSwipeHelper(
    context: Context,
    ...
    override fun onChildDraw(
        ...
        val expenditureViewHolder = viewHolder as? ExpenditureViewHolder ?: return
        val pos = expenditureViewHolder.adapterPosition
        var translationX = dX
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            if (dX < 0) {
                ...
                if (!buttonBuffer.containsKey(pos)) {
                    val expenditure = expenditureViewHolder.expenditure ?: return
                    instantiateMyButton(expenditure, buffer)
